...
```shell
转换为有序MAP后的内容: {businessNo=P0001, clientIp=127.0.0.1, notNotify=true, notReturn=true, payChannels=[{"amount":"1","channel":"wechat_pay","way":"qrcode"}], reqTime=1707408964, title=测试接口支付, version=1.0}

将MAP拼接字符串, 并过滤掉特殊字符: businessNo=P0001&clientIp=127.0.0.1&notNotify=true&notReturn=true&payChannels=[{amount:1,channel:wechat_pay,way:qrcode}]&reqTime=1707408964&title=测试接口支付&version=1.0

添加秘钥并转换为大写的字符串: BUSINESSNO=P0001&CLIENTIP=127.0.0.1&NOTNOTIFY=TRUE&NOTRETURN=TRUE&PAYCHANNELS=[{AMOUNT:1,CHANNEL:WECHAT_PAY,WAY:QRCODE}]&REQTIME=1707408964&TITLE=测试接口支付&VERSION=1.0&SIGN=123456

MD5: e67e1d3ecdabba6a53211f3d352583d3

HmacSHA256: 3691476a2ba8799c9ca9d8a1565fea0384d0be74d9117eaadf4edd9e5321b38e
-----------------------------------------------------------------------------------------------------------------------------------------
转换为有序MAP后的内容: {businessNo=P0002, clientIp=127.0.0.1, notNotify=false, notReturn=false, payChannels=[{"amount":"1","channel":"wechat_pay","channelParam":"{\"authCode\":\"123456\",\"openId\":\"6688812\"}","way":"qrcode"}], reqTime=1707408964, title=测试接口支付, version=1.0}

将MAP拼接字符串, 并过滤掉特殊字符: businessNo=P0002&clientIp=127.0.0.1&notNotify=false&notReturn=false&payChannels=[{amount:1,channel:wechat_pay,channelParam:{authCode:123456,openId:6688812},way:qrcode}]&reqTime=1707408964&title=测试接口支付&version=1.0

添加秘钥并转换为大写的字符串: BUSINESSNO=P0002&CLIENTIP=127.0.0.1&NOTNOTIFY=FALSE&NOTRETURN=FALSE&PAYCHANNELS=[{AMOUNT:1,CHANNEL:WECHAT_PAY,CHANNELPARAM:{AUTHCODE:123456,OPENID:6688812},WAY:QRCODE}]&REQTIME=1707408964&TITLE=测试接口支付&VERSION=1.0&SIGN=123456
