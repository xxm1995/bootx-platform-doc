    ...
    '/platform/overview/': [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    text: '安装platformker',
                    link: '/platform/overview/config/安装platformker',
                },
                {
                    text: '相关platformker-compose',
                    link: '/platform/overview/config/相关platformker-compose',
                },
            ]
        },
        {
    ...
    '/platform/server/common/': [
        {
            ...
            children: [
                ...
                {
                    text: '自动建表',
                    link: '/platform/server/common/自动建表' ,
                },
                {
                    text: '缓存模块',
                ...
                {
                    text: '分布式锁',
                    link: '/platform/server/common/分布式锁',
                },
                {
                    text: 'JackSon配置',
    ...
    '/platform/server/service/': [
        {
            ...
            children: [
                ...
                {
                    text: '身份识别与访问管理',
                    link: '/platform/server/service/身份识别与访问管理',
                },
                {
                    text: '通知服务',
                    link: '/platform/server/service/通知服务',
                },
                {
                    text: '支付服务',
                    link: '/platform/server/service/支付服务',
                },
            ]
        }
    ],
