import{_ as n,c as a,o as s,a as t}from"./app.95c78e2d.js";const y='{"title":"MySQL","description":"","frontmatter":{},"headers":[{"level":2,"title":"MySQL","slug":"mysql"},{"level":2,"title":"Redis","slug":"redis"},{"level":2,"title":"MongoDB","slug":"mongodb"},{"level":2,"title":"RabbitMQ","slug":"rabbitmq"},{"level":2,"title":"ELK","slug":"elk"},{"level":2,"title":"MQTT","slug":"mqtt"},{"level":2,"title":"TdEngine","slug":"tdengine"}],"relativePath":"doc/overview/config/\u76F8\u5173docker-compose.md"}',e={},p=t(`<h2 id="mysql" tabindex="-1">MySQL <a class="header-anchor" href="#mysql" aria-hidden="true">#</a></h2><h2 id="redis" tabindex="-1">Redis <a class="header-anchor" href="#redis" aria-hidden="true">#</a></h2><div class="language-yaml"><pre><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
...
</code></pre></div><h2 id="mongodb" tabindex="-1">MongoDB <a class="header-anchor" href="#mongodb" aria-hidden="true">#</a></h2><div class="language-yaml"><pre><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
...
</code></pre></div><h2 id="rabbitmq" tabindex="-1">RabbitMQ <a class="header-anchor" href="#rabbitmq" aria-hidden="true">#</a></h2><div class="language-yaml"><pre><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
...
</code></pre></div><h2 id="elk" tabindex="-1">ELK <a class="header-anchor" href="#elk" aria-hidden="true">#</a></h2><div class="language-yaml"><pre><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
...
</code></pre></div><h2 id="mqtt" tabindex="-1">MQTT <a class="header-anchor" href="#mqtt" aria-hidden="true">#</a></h2><h2 id="tdengine" tabindex="-1">TdEngine <a class="header-anchor" href="#tdengine" aria-hidden="true">#</a></h2><div class="language-yaml"><pre><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
...
</code></pre></div>`,12),o=[p];function c(u,l,k,i,r,d){return s(),a("div",null,o)}var g=n(e,[["render",c]]);export{y as __pageData,g as default};
