import{_ as n,f as a,e as s,N as t}from"./plugin-vue_export-helper.c921523c.js";const g='{"title":"TdEngine","description":"","frontmatter":{},"headers":[{"level":2,"title":"TdEngine","slug":"tdengine"}],"relativePath":"doc/overview/config/\u76F8\u5173docker-compose.md","lastUpdated":1671720200244}',e={},p=t(`<h2 id="tdengine"><a class="header-anchor" href="#tdengine" aria-hidden="true">#</a> TdEngine</h2><div class="language-yaml"><pre><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
...
</code></pre></div>`,2),o=[p];function c(u,l,i,k,r,d){return s(),a("div",null,o)}var m=n(e,[["render",c]]);export{g as __pageData,m as default};
